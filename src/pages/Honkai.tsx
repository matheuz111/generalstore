  ...
  return (
    ...
    >
      ...
      <div className="mt-12 text-sm text-gray-400 max-w-3xl space-y-4">
        ...
        <p>✨ <span className="text-white font-medium">BONUS x2</span> disponible para cuentas que nunca hayan recargado.</p>
        <p>🔁 Si la cuenta ya ha recargado anteriormente, solo se aplicará el bono indicado.</p>
        <p>🔒 No se requiere cuenta ni contraseña. Recarga 100% segura.</p>
      </div>
    </CategoryShell>
  );
};
